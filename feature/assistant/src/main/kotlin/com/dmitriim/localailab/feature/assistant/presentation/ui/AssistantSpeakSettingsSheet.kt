...
import com.dmitriim.localailab.feature.assistant.presentation.SpeechOutputSettings
import com.dmitriim.localailab.feature.assistant.presentation.TtsModelOption
...
private fun speechModelSelection(
    ...
    val language = assistantTtsLanguages.firstOrNull { candidate ->
        model?.languages?.isEmpty() == true ||
            model?.languages?.any {
                com.dmitriim.localailab.feature.assistant.presentation.normalizeLanguageCode(it) == candidate.code
            } == true
    }?.code ?: "en"
        ...
        assistantTtsLanguages.forEach { language ->
            val supported = selectedModel?.languages?.isEmpty() == true ||
                selectedModel?.languages?.any {
                    com.dmitriim.localailab.feature.assistant.presentation.normalizeLanguageCode(it) == language.code
                } == true
            FilterChip(
