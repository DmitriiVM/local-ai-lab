package com.dmitriim.localailab.feature.models.presentation.ui
...
private fun CatalogModelCard(
    ...
    huggingFaceCredentialStatus: com.dmitriim.localailab.core.model.service.HuggingFaceCredentialStatus,
    onOpenDetails: (ModelId) -> Unit,
    onDownload: (ModelId) -> Unit,
    ...
    val accessRequired = model.download.authentication == CatalogDownloadAuthentication.HUGGING_FACE_USER_TOKEN &&
        huggingFaceCredentialStatus == com.dmitriim.localailab.core.model.service.HuggingFaceCredentialStatus.MISSING
...
private fun com.dmitriim.localailab.core.model.library.ModelTransferNetworkPolicy.networkLabelRes(): Int = when (this) {
    com.dmitriim.localailab.core.model.library.ModelTransferNetworkPolicy.WIFI_ONLY -> CoreUiR.string.models_network_wifi_only
    com.dmitriim.localailab.core.model.library.ModelTransferNetworkPolicy.ANY_NETWORK -> CoreUiR.string.models_network_any
}
