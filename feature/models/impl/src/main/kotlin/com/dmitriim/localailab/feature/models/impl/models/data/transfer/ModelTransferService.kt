...
import com.dmitriim.localailab.feature.models.impl.models.domain.transfer.ModelDownloadRetryPolicy
import com.dmitriim.localailab.feature.models.impl.models.domain.transfer.ModelTransferProgress
import com.dmitriim.localailab.feature.models.impl.models.domain.transfer.ModelTransferThroughputEstimator
...
class ModelTransferService(
    ...
    private fun publishDownloadProgress(transfer: StoredModelTransfer) {
        throughputEstimator.record(
            ModelTransferProgress(
                modelId = ModelId(transfer.modelId),
                executionGeneration = transfer.executionGeneration,
