package com.dmitriim.localaiplayground.feature.stt.navigation
...
import com.dmitriim.localaiplayground.feature.stt.presentation.SpeechToTextRoute
...
class SpeechToTextNavigationEntryProvider : NavigationEntryProvider {
    ...
    override fun entryFor(key: NavKey, navigator: AppNavigator): NavEntry<NavKey>? =
        if (key == SpeechToTextKey) NavEntry(key) { SpeechToTextRoute() } else null
}
