...
private fun TextToSpeechModelSelectionSheet(
    ...
    val installedModels = models.filter(TtsModelOption::installed)
    val availableModels = models.filterNot(TtsModelOption::installed)
                ...
                if (availableModels.isNotEmpty()) {
                    ...
                    if (showAvailableModels) {
                        items(availableModels, key = { it.id.value }) { model ->
                            UnavailableTextToSpeechModelRow(model)
                        }
                    }
                }
            }
...
@Composable
private fun TextToSpeechModelOptionRow(
...
@Composable
private fun UnavailableTextToSpeechModelRow(model: TtsModelOption) {
    Column(
