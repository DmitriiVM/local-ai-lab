package com.dmitriim.localailab.core.performance.resource.android
...
@ContributesBinding(AppScope::class, binding = binding<ResourceTelemetrySampler>())
class AndroidResourceTelemetrySampler(
    ...
    override fun snapshot(): PerformanceResourceSnapshot = PerformanceResourceSnapshot(
    ...
    override fun deviceProfile() = DevicePerformanceProfile(
    ...
    private fun BatteryManager.longPropertyOrNull(property: Int): Long? = getLongProperty(property)
        .takeUnless { it == Long.MIN_VALUE }

    private fun BatteryManager.intPropertyOrNull(property: Int): Int? = getIntProperty(property)
