...
import com.dmitriim.localaiplayground.source.models.catalog.download.huggingFaceFiles
...
internal val supertonicCatalogEntry: CatalogModel = CatalogModel(
    manifest = ModelManifest(
        ...
        source = ModelSource(
            ...
            revision = supertonicRevision,
            licenseName = "MIT",
            attribution = CatalogDefaults.MIT_ATTRIBUTION,
        ),
        languages = linkedSetOf("English", "Russian", "German"), supportedLanguageCount = 31, sampleRateHz = 44_100,
        speakerCount = 10,
        voices = supertonicV3Voices(),
        approximateRamBytes = 900_000_000, catalogVersion = CatalogDefaults.VERSION, installedAtEpochMs = 0,
    ),
