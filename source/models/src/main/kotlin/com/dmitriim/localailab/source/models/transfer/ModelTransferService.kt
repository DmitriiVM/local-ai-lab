...
import com.dmitriim.localailab.source.models.validation.sha256
...
class ModelTransferService(
    ...
    private suspend fun downloadFileWithRetries(
        ...
        authorizationToken: String?,
        existingValidator: com.dmitriim.localailab.source.database.ModelTransferFileEntity?,
    ): StoredModelTransfer {
    ...
    private fun openResponse(
        url: String,
        offset: Long,
        validator: com.dmitriim.localailab.source.database.ModelTransferFileEntity?,
        authorizationToken: String?,
        modelId: ModelId,
    ): DownloadResponse {
        var currentUrl = url
