package com.dmitriim.localailab.ai.performance.profiling.android
...
import com.dmitriim.localailab.ai.api.profiling.InferencePhaseDuration
import com.dmitriim.localailab.ai.api.profiling.InferenceProfileSession
...
class AndroidInferenceProfiler(
    private val sampler: ResourceTelemetrySampler,
    ...
    private class Session(
        ...
        private val device = sampler.deviceProfile().toInferenceDeviceSnapshot()
        ...
        private fun resourceMetrics(
            start: PerformanceResourceSnapshot,
            end: PerformanceResourceSnapshot,
            samples: List<PerformanceResourceSnapshot>,
        ...
        private fun DevicePerformanceProfile.toInferenceDeviceSnapshot() = InferenceDeviceSnapshot(
