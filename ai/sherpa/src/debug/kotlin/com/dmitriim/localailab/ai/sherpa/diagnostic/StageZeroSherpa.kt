...
object StageZeroSherpa {
    fun transcribeWhisper(modelDirectory: File, wavFile: File): StageZeroSttResult {
        requireComplete(modelDirectory, StageZeroSherpaProfiles.whisperBaseRequiredFiles, "Whisper Base")
    ...
    fun synthesizeSupertonic(modelDirectory: File, text: String): StageZeroTtsResult {
        requireComplete(modelDirectory, StageZeroSherpaProfiles.supertonic3RequiredFiles, "Supertonic 3")
    ...
    private fun requireComplete(directory: File, required: Set<String>, profile: String) {
        val missing = StageZeroSherpaProfiles.missingFiles(directory, required)
